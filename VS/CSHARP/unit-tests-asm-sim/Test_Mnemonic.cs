...
namespace unit_tests_asm_z3
{
    ...
    public class Test_Mnemonic
    {
        ...
        private static readonly Tv[] arrayUnknown64 = new Tv[64];
        private static readonly Tv[] arrayUnknown32 = new Tv[32];
        private static readonly Tv[] arrayUnknown16 = new Tv[16];
        private static readonly Tv[] arrayUnknown8 = new Tv[8];
        ...
        public void Test_MnemonicZ3_Mov_reg3()
        {
            ...
            string line3 = "mov eax, " + value_eax_2;
            {
                ...
                TestTools.AreEqual(Rn.RBX, arrayUnknown64, state);
        ...
        public void Test_MnemonicZ3_Mov_mem3()
        {
            ...
            {   // forward
                ...
                state = Runner.SimpleStep_Forward(line3, state);
                if (logToDisplay) Console.WriteLine("After \"" + line3 + "\", we know:\n" + state);
                state.Add(new BranchInfo(ToolsAsmSim.ConditionalTaken(ConditionalElement.NZ, state.HeadKey, state.Ctx), false, state.LineNumber));
                if (logToDisplay) Console.WriteLine("After \"" + line4 + "\", we know:\n" + state);
        ...
        public void Test_MnemonicZ3_Sub_2()
        {
            ...
            {   // forward
                ...
                BitVecExpr al0 = state.Get(Rn.AL);
                BitVecExpr bl0 = state.Get(Rn.BL);
        ...
        public void Test_MnemonicZ3_Btc_1()
        {
            ...
            {   // forward
                ...
                state = Runner.SimpleStep_Forward(line2, state);
                if (logToDisplay) Console.WriteLine("After \"" + line2 + "\", we know:\n" + state);
                //TestTools.test(Rn.RAX, arrayUnknown64, state);
        ...
        public void Test_MnemonicZ3_Rcr_4()
        {
            ...
            {   // forward
                ...
                if (logToDisplay) Console.WriteLine("After \"" + line1 + "\", we know:\n" + state);
                TestTools.AreEqual(Rn.RAX, arrayUnknown64, state);
                //TestTools.Test(Rn.RBX, arrayUnknown64, state);
