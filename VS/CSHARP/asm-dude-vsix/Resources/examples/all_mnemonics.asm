...
#region 8086: contains a lot of wrong instructions that have no arch description in the INTEL manuals
    HLT   ; 8086
    MOV   ; 8086 386 X64
    XCHG   ; 8086 386 X64
    XADD   ; 8086 386 X64
...
#region AVX
    ...
    VZEROALL   ; AVX
    VZEROUPPER   ; AVX
    VGF2P8AFFINEINVQB   ; AVX AVX512_VL AVX512_F
    VGF2P8AFFINEQB   ; AVX AVX512_VL AVX512_F
    VGF2P8MULB   ; AVX AVX512_VL AVX512_F
    ...
    VPCLMULQDQ   ; AVX AVX512_VL AVX512_F
#endregion AVX
#region AVX2
    VBROADCASTSS   ; AVX AVX512_VL AVX512_F AVX2
    VBROADCASTSD   ; AVX AVX512_VL AVX512_F AVX2
